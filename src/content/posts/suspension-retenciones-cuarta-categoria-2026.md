---
title: "Suspensión de retenciones de cuarta categoría 2026: cómo tramitarla y cuándo conviene"
description: "Si ganas menos de S/ 48,125 al año como trabajador independiente, puedes cobrar el 100% de tus honorarios sin retenciones. Guía paso a paso del Formulario 1609 en SUNAT."
...
## ¿Qué es la suspensión de retenciones y por qué importa?
...
| Tipo de renta | Límite mensual | Límite anual |
|---|---|---|
| Cuarta categoría (profesión, arte u oficio) | S/ 4,010 | **S/ 48,125** |
| Cuarta + Quinta categoría (combinadas) | S/ 4,010 | **S/ 48,125** |
| Director de empresa, síndico, mandatario, gestor de negocios, albacea | S/ 3,208 | **S/ 38,500** |
...
- Cuánto llevas ganado en el año hasta la fecha de la solicitud.
- Cuánto proyectas ganar hasta diciembre.
- Las retenciones que ya te efectuaron.
...
- RUC activo (con estado "Activo" y condición "Habido").
- **Clave SOL** (usuario y contraseña para SUNAT Operaciones en Línea).
- Estimado de tus ingresos del año: cuánto llevas cobrado y cuánto esperas cobrar hasta diciembre.
...
- Ingresos de cuarta categoría cobrados en el año hasta hoy.
- Ingresos proyectados hasta diciembre.
- Retenciones ya efectuadas en el año (el sistema puede pre-llenar algunas).
...
| Escenario | Lo que cobras por recibo de S/ 2,500 | Diferencia |
|---|---|---|
| Sin suspensión (retención 8%) | S/ 2,300 | — |
| Con suspensión | **S/ 2,500** | **+S/ 200 por recibo** |
...
- Es válida desde el **día siguiente al otorgamiento**.
- Vence el **31 de diciembre de 2026**.
- Puedes pedirla en **cualquier momento del año**, desde el 1 de enero.
- Para 2027 necesitas tramitar una nueva constancia desde enero de ese año.
...
- **Solicitar la suspensión cuando tus ingresos claramente superarán el límite.** El sistema puede rechazarla si los datos proyectados no cuadran.
- **Creer que la suspensión elimina la declaración anual.** No la elimina. Si tus ingresos superaron el umbral de obligatoriedad, igual debes declarar.
- **Olvidar renovarla el año siguiente.** La constancia de 2026 no sirve para 2027. Debes tramitar una nueva en enero de cada año.

---

## Preguntas frecuentes

**¿Puedo tramitar la suspensión aunque ya me retuvieron varios meses?**
Sí. La solicitas en cualquier momento del año. Lo retenido hasta ese momento lo recuperas en la declaración anual. La suspensión evita nuevas retenciones de aquí en adelante.

**¿Si tengo ingresos de cuarta y quinta al mismo tiempo, cómo calculo el límite?**
El límite de S/ 48,125 aplica a la suma combinada de ambas categorías. Si la suma no supera ese monto, puedes pedir la suspensión.

**¿El trámite tiene algún costo?**
No. El Formulario 1609 es completamente gratuito y se hace en línea con tu Clave SOL.

**¿Cuánto tarda la aprobación?**
Es inmediata si calificas. El sistema aprueba o rechaza en el momento en que envías el formulario.

**¿Tengo que renovarla cada mes?**
No. Una vez aprobada, es válida hasta el 31 de diciembre del año vigente. No necesitas tramitar nada más durante el año.

**¿Qué hago si el sistema rechaza mi solicitud?**
Significa que tus datos proyectados muestran que superarás el límite. En ese caso, las retenciones continúan y las regularizas en la declaración anual.
