---
title: "Presupuesto personal para sueldo peruano: método simple que sí funciona"
description: "Cómo organizar tu sueldo con el método 50/30/20 adaptado a Lima 2026: gastos reales, ejemplos con S/ 1,800 y S/ 2,500, y herramientas para empezar hoy mismo."
...
| Bloque | Porcentaje | ¿Para qué sirve? |
|---|---|---|
| **Necesidades** | 50% | Alquiler, comida, transporte, servicios básicos, salud |
| **Gustos** | 30% | Salidas, ropa, entretenimiento, delivery, caprichos |
| **Ahorro / deudas** | 20% | Fondo de emergencias, metas de ahorro, cuotas de deuda |
...
| Gasto | Costo estimado Lima 2026 |
|---|---|
...
- ¿Cuánto enviaste en total?
- ¿A quiénes (tiendas, casero, servicios, amigos)?
- ¿Hay gastos repetidos que no recuerdas haber hecho?
...
Para sacarle más provecho a estas herramientas, mira nuestra comparativa de **[Yape vs Plin: cuál conviene para tu negocio y tus finanzas](/posts/yape-vs-plin-cual-conviene-negocio-finanzas/)**.
...
**¿Cuánto necesitas?**
- Mínimo: 1 mes de gastos fijos (S/ 900-1,250 según tu sueldo).
- Ideal: 3 meses de gastos fijos (S/ 2,700-3,750).

**¿Dónde guardarlo?**
En una cuenta de ahorros aparte de tu cuenta principal. No en Yape ni Plin — el dinero ahí es demasiado accesible y no genera intereses. Una cuenta de ahorros en tu banco con retiro libre es suficiente.

**¿Cuánto tarda en construirse?**
Con S/ 200-360/mes de ahorro, puedes tener S/ 1,000 en 3-5 meses. Pequeño pero suficiente como primera red de seguridad.
...
| Gasto invisible | Cómo controlarlo |
|---|---|
| Suscripciones acumuladas (Netflix, Spotify, apps) | Revisa los débitos automáticos de tu tarjeta cada mes |
| Cumpleaños, reuniones, regalos | Presupuesta S/ 50-100/mes en el bloque de gustos |
| Transporte de emergencia (taxis cuando falla el bus) | Reserva S/ 50-80/mes para movilidad imprevista |
| Consultas médicas sin seguro | S/ 80-150 por consulta; necesitas el fondo de emergencias |

---

## ❌ Errores comunes al hacer un presupuesto

- **Presupuestar lo que quisieras gastar, no lo que realmente gastas.** Primero registra un mes sin cambiar nada. Eso te da la línea base real.
- **No incluir gastos anuales.** El SOAT, la renovación de contrato, la matrícula del gimnasio. Divide entre 12 y agrégalos al presupuesto mensual.
- **Ahorrar "lo que sobre".** Siempre "sobra" cero. El ahorro va primero, antes de los gustos.
- **Rendirse después del primer mes fallido.** Un mes malo no invalida el método. Analiza por qué fallaste y ajusta.
- **Ignorar las deudas.** Si tienes cuotas de crédito o deuda de tarjeta, el 20% de ahorro/deuda las incluye. Primero paga las deudas más caras (tarjeta de crédito), luego ahorra.

---

## Preguntas frecuentes

**¿Funciona el método con sueldo mínimo (S/ 1,025)?**
Con S/ 1,025, el 50% para necesidades (S/ 512) no cubre el alquiler en Lima. En ese rango, el enfoque prioritario debe ser aumentar ingresos (trabajo adicional, freelance) o reducir gastos fijos radicalmente (vivir con familia, fuera de Lima). El método funciona mejor a partir de S/ 1,500.

**¿Y si tengo deudas grandes?**
Prioriza pagarlas con el bloque del 20%. Si la deuda es urgente, destina el 20% completo a pagarla hasta liquidarla, luego cambia a ahorro. Si es grande, divide: 10% para deuda y 10% para fondo de emergencias mínimo.

**¿Tengo que registrar cada sol que gasto?**
No. Con revisar el historial de Yape/Plin y los extractos de tu cuenta una vez a la semana es suficiente. Para efectivo, una nota rápida al momento de gastar.

**¿A partir de cuándo conviene invertir?**
Cuando tengas el fondo de emergencias de 3 meses cubierto y tus deudas de alto interés saldadas. Antes de eso, invertir es construir sobre arena.

**¿El método cambia si soy independiente con honorarios?**
Sí. Si tus ingresos varían cada mes, calcula tu presupuesto sobre el promedio de los últimos 6 meses o sobre tu ingreso más bajo del año — no sobre el mejor mes. En los meses buenos, destina el extra al fondo de emergencias.
...
👉 ¿Quieres mejorar la gestión de tus pagos digitales? Mira nuestra comparativa de **[Yape vs Plin: cuál conviene para tu negocio y tus finanzas personales](/posts/yape-vs-plin-cual-conviene-negocio-finanzas/)**. Y si eres trabajador independiente con honorarios, la guía de **[cómo declarar tus impuestos de cuarta categoría](/posts/como-declarar-impuestos-trabajador-independiente-honorarios/)** es lectura obligada para organizar lo que realmente te queda después de impuestos.
